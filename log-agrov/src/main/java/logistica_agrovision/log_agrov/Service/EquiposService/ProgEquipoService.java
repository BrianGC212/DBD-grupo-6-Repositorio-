...
public class ProgEquipoService {
   ...
   Timestamp currentTime = Timestamp.valueOf(LocalDateTime.now()); // Obtener la fecha y hora actuales
    ...
    public List<Empleado> obtenerEmpleados() {
        String SQL="SELECT id_empleado,nombre_apellido FROM empleado";
        List<Empleado> empleados=jdbcTemplate.query(SQL,new BeanPropertyRowMapper<>(Empleado.class));
        return empleados;
    }

    public List<Area> getAreas(){
        String SQL="SELECT id_area,nombre_del_area AS nombre FROM area";
        List<Area> areas=jdbcTemplate.query(SQL,new BeanPropertyRowMapper<>(Area.class));
        return areas;
    }

    public List<Equipo> getEquipos(){
        String SQL="SELECT id_equipos AS idEquipo,nombre_equipo AS nombre FROM equipos";
        List<Equipo> equipos=jdbcTemplate.query(SQL,new BeanPropertyRowMapper<>(Equipo.class));
        return equipos;
    }
}
